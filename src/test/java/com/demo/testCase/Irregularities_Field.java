...
import com.demo.pom.EvidencePage;
...
public class Irregularities_Field extends BaseClass {
	 ...
	 AllotPendingCasePage apc;
	  ...
	  RobotClass rc;
	  CaseDetailsPage cdp;
	  AllotAttendCaseDataBase allotAttend;
	  CommonDataPage commonData;
	...
	public void toFillTheIrregularitiesOfMainMeter() throws AWTException, InterruptedException {
	   ...
	   // ep.clickOnSubmitButton();
	    ...
	    Thread.sleep(2000);
	    alert.accept();
	    logger.info("Alert Message " +alertMessage+" is Displayed.");
	}
	@Test(priority = 3)
	...
	@Test(priority = 5)
	public void toSavedIrregulatiesFieldDetailsInExcelFile() throws EncryptedDocumentException, ClassNotFoundException, SQLException, IOException {
		allotAttend = new AllotAttendCaseDataBase();
		commonData=new CommonDataPage(driver);
		  List<String> allPendingCasesDetailsOnDB = allotAttend.toverifyfieldIrregulatiesCaseDetailsInDatabase();
		for (String text : allPendingCasesDetailsOnDB) {
			commonData.writeIrregularitiesFieldDetailsInExcelFile(text);
		}
