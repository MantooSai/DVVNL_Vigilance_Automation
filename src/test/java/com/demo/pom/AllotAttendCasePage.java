...
public class AllotAttendCasePage {
    ...
    public List<String> AllotAttendPendingCaseDetails() {
    	 ArrayList<String> AllotAttendPendingCaseDetails = new ArrayList<>();
		    for (int i = 2; i < allAllotAttendCaseDetails.size(); i++) {
		    	AllotAttendPendingCaseDetails.add(allAllotAttendCaseDetails.get(i).getText().trim());
		    }
		    return AllotAttendPendingCaseDetails;
    }
